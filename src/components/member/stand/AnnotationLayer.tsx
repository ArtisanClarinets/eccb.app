      ...
      {editMode && currentTool === Tool.STAMP && (
        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 z-50">
          <button
            ...
            className="px-3 py-1 bg-card border rounded shadow text-xs font-medium hover:bg-muted transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
            title="Select stamp"
          >
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 bg-card border rounded shadow-lg p-2 grid grid-cols-4 gap-1 w-64">
              {STAMPS.map((stamp) => (
                <button
                  ...
                  className={`px-1 py-1 text-xs border rounded hover:bg-primary/10 transition-colors truncate focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
