  ...
  describe('bootstrapSmartUploadSettings', () => {
    ...
    it('should return empty actions when all settings exist', async () => {
      mockPrismaSystemSettingFindMany.mockResolvedValue([
        ...
        { key: 'llm_openai_api_key', value: '' },
        { key: 'llm_anthropic_api_key', value: '' },
        { key: 'llm_openrouter_api_key', value: '' },
        { key: 'llm_gemini_api_key', value: '' },
        { key: 'llm_custom_api_key', value: '' },
        ...
        { key: 'smart_upload_skip_parse_threshold', value: '50' },
        ...
        { key: 'llm_adjudicator_model', value: '' },
        { key: 'llm_header_label_prompt', value: 'Prompt' },
        { key: 'llm_adjudicator_prompt', value: 'Prompt' },
